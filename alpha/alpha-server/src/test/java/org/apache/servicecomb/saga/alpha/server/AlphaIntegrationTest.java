...
@SpringBootTest(classes = {AlphaApplication.class, AlphaConfig.class},
    properties = {
        ...
        "alpha.server.ssl.enable=true", "alpha.server.ssl.cert=certs/server.crt",
        "alpha.server.ssl.key=certs/server.pem", "alpha.server.ssl.enableMutualAuth=true",
        "alpha.server.ssl.clientCert=certs/client.crt"})
